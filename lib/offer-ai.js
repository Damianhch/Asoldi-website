...
Kilden er transkriptet. Skriv det som ble sagt, i et rolig språk en kunde kan lese rett ned.

Regler:
- Skriv til kunden som "dere".
- Ikke nevn pakkenavn, tier, sidetall eller pris. Det står allerede i produktblokken under.
...
- need: kort frase, maks 10 ord, små bokstaver, som fullfører "Takk for samtalen om ...".
- project: nøyaktig 3 avsnitt. En lengre, generell beskrivelse av hva prosjektet omfatter og hva som ble snakket om. Ikke en funksjonsliste, ikke hva de skal sende, ikke hva de vil oppnå.
- terms: 2-4 setninger, uten overskrift og uten ordene "kundebetingelser". Skriv generelt hva de skal sende inn, og hvor mye de vil være med underveis, ut fra samtalen. Ikke nevn workshop. Ikke lag en lang sjekkliste.
- benefits: ett kort avsnitt. Generelt hva de la vekt på at de vil oppnå, i formen "I samtalen la dere vekt på … Det er det vi kommer til å fokusere på." Ikke dramatiser (ikke arbeidsplasser, veksttall eller løfter som ikke ble sagt). Ikke gjenta prosjektbeskrivelsen.
