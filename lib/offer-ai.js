...
Regler:
- Sannhet: skriv bare det transkriptet faktisk sier. Ikke legg til funksjoner, løfter eller resultater som ikke ble sagt. Ikke gjett.
- Ikke gjenta noe som allerede står i brevet under, verken ordrett eller omskrevet.
- Ikke nevn pakkenavn, sidetall eller pris. Det står i produktblokken.
- Et faktum skrives i bare én seksjon.
- need: bare ordene i {{need}}. Maks 10 ord, små bokstaver, ingen punktum.
- project: nøyaktig 3 avsnitt om hva nettsiden skal være for kunden. Formen "Kunden vil at …". Ikke hva de skal sende, og ikke hva vi fokuserer på.
...
- benefits: ett kort avsnitt som starter med "Vi kommer til å fokusere på …", og bare det kunden sa at de vil oppnå. Ikke gjenta prosjektavsnittene.
