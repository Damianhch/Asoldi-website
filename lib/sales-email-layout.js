...
function logoRow(assets, { color = '#ffffff', markSrc = '' } = {}) {
  const src = markSrc || assets.logoMark;
  return `
    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td valign="middle" style="padding-right:10px;">
          <img src="${attr(src)}" width="28" height="28" alt="Asoldi" style="display:block;border:0;width:28px;height:28px;" />
        </td>
        <td valign="middle" style="${fontStyle()}font-size:22px;color:${color};">Asoldi</td>
      </tr>
    </table>`;
}
