...
export const Hero = () => {
  ...
  return (
    <section id="Home" className="relative pt-20 pb-4 md:pt-32 md:pb-20 px-6 md:px-10 overflow-hidden bg-[#050505] h-[100dvh] lg:h-auto flex flex-col justify-center">
      {/* Decorative Line SVG */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center items-center text-center md:items-start md:text-left">
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-[100px] leading-[0.9] font-medium tracking-tight mb-3 md:mb-12 text-[#FF5B00]"
            >
              Vi er din ekspert på <span className="font-serif italic font-normal block text-white">digital vekst</span>
            </motion.h1>
            
            <div className="flex flex-wrap gap-1.5 sm:gap-2 md:gap-3 max-w-md justify-center md:justify-start mb-2 md:mb-10">
          ...
          <div className="lg:col-span-4 relative flex flex-col items-center justify-center gap-2 lg:gap-0">
            <motion.div 
              ...
              className="relative w-full max-w-[260px] md:max-w-[400px] aspect-[4/3] md:aspect-[3/4] rounded-t-[24px] md:rounded-t-[200px] overflow-hidden border-x border-t border-white/10 mx-auto"
            >
              <img 
            ...
            {/* Social proof - mobile only, between image and CTA (1:1 replica of desktop Stat 1, text = Resultater) */}
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="lg:hidden flex items-center justify-center gap-3 py-2 hover:opacity-95 transition-opacity w-full"
            >
              ...
              <div className="flex flex-col">
                ...
                <div className="text-[#FF5B00] text-3xl font-serif italic font-bold leading-tight mt-1">
                  Resultater
                </div>
              </div>
              <div>
          ...
          {/* Right Column - Stats (desktop only; mobile: social proof moved to middle column) */}
