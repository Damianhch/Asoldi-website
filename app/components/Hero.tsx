...
export const Hero = () => {
  ...
  return (
    <section id="Home" className="relative pt-20 pb-8 md:pt-32 md:pb-20 px-6 md:px-10 overflow-hidden bg-[#050505] min-h-[100dvh] lg:min-h-0 flex flex-col justify-center">
      {/* Decorative Line SVG */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center items-center text-center md:items-start md:text-left">
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-[100px] leading-[0.9] font-medium tracking-tight mb-4 md:mb-12 text-[#FF5B00]"
            >
              Vi er din ekspert på <span className="font-serif italic font-normal block text-white">digital vekst</span>
            </motion.h1>
            
            <div className="flex flex-wrap gap-1.5 sm:gap-2 md:gap-3 max-w-md justify-center md:justify-start mb-3 md:mb-10">
          ...
          <div className="lg:col-span-4 relative flex flex-col items-center justify-center gap-3 lg:gap-0">
            ...
            <motion.a
              ...
              className="lg:hidden w-full max-w-[330px] bg-[#0b0b0b] px-3 py-2 flex items-center justify-between gap-3 hover:opacity-95 transition-opacity"
            >
              ...
              <div className="flex flex-col items-start flex-1">
                ...
                <div className="text-white font-semibold text-sm leading-tight mt-1 whitespace-nowrap">
                  10+ fornøyde kunder
                </div>
              </div>
          ...
          <div className="lg:col-span-3 lg:col-start-10 flex flex-col gap-6 md:gap-12 pl-0 md:pl-8 items-center text-center md:items-start md:text-left">
            ...
            >
              ...
              >
                <div className="hidden lg:flex relative items-center justify-center md:justify-start gap-3">
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 rounded-full bg-gray-700 overflow-hidden">
                      <img src="/media/christopher.avif" alt="Christopher" className="w-full h-full object-cover" />
                    </div>
