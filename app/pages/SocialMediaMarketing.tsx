...
export const SocialMediaMarketing = () => {
  ...
  const processSteps = [
    { 
      title: 'Strategi.', 
      description: 'Vi starter med å forstå dine mål, målgruppe og markedsposisjon. Vi legger en plan som sikrer at hver krone brukt på markedsføring gir maksimal avkastning.', 
      icon: <Network size={48} strokeWidth={1.5} className="text-[#FF5B00]" /> 
    },
    { 
      title: 'Innhold.', 
      description: 'Vårt kreative team produserer engasjerende innhold som stopper scrollen. Vi fokuserer på visuell historiefortelling som bygger tillit og skaper lyst på dine tjenester.', 
      icon: <PenTool size={48} strokeWidth={1.5} className="text-[#FF5B00]" /> 
    },
    { 
      title: 'Annonsering.', 
      description: 'Vi setter opp og optimaliserer kampanjer på Facebook og Instagram. Ved hjelp av avansert målretting når vi ut til de personene som er mest sannsynlig å bli dine kunder.', 
      icon: <Code2 size={48} strokeWidth={1.5} className="text-[#FF5B00]" /> 
    },
    { 
      title: 'Vekst.', 
      description: 'Vi overvåker resultatene kontinuerlig og justerer strategien for å skalere det som fungerer. Du får faste rapporter som viser nøyaktig hvordan din bedrift vokser.', 
  ...
  return (
    <div className="bg-[#050505] min-h-screen">
      <SEO
        title={`Sosiale Medier Marketing – ${BUSINESS.shortName} | Trondheim`}
        description="Øk din tilstedeværelse på sosiale medier med strategi, innholdsplan og kampanjer. Sosiale medier marketing fra Asoldi i Trondheim."
        path="/services/social-media"
        structuredData={getServiceSchema('Sosiale Medier Marketing', 'Strategi, innhold og kampanjer for sosiale medier.', SITE_URL + '/services/social-media')}
      />
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl lg:text-[80px] font-medium text-white mb-6 tracking-tight leading-[1.05]">
                Skap engasjement,<br /><span className="text-[#FF5B00]">bygg din merkevare</span>
              </h1>
              <p className="text-lg md:text-xl lg:text-2xl text-white/60 font-light mb-10 max-w-lg leading-relaxed">
                Gjør følgere om til lojale kunder. Oppdag hvorfor bedrifter stoler på oss med sin tilstedeværelse i sosiale medier.
              </p>
      ...
      {/* Pricing CTA */}
      <PricingCTA serviceName="Sosiale Medier" />
