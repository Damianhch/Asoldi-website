...
export const WebDevelopment = () => {
  ...
  const caseStudies = [
    { name: 'Svelstad Eiendom', category: 'Eiendom', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80' },
    { name: 'Swich App', category: 'SaaS Plattform', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80' },
    { name: 'Mong Sushi Portal', category: 'Web Applikasjon', image: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&q=80' },
  ];

  const processSteps = [
    { 
      title: 'Planlegging.', 
      description: 'Vi starter med å forstå dine mål, målgruppe og tekniske krav for å lage et omfattende veikart for prosjektet ditt. Dette sikrer at vi bygger nøyaktig det bedriften din trenger for å vokse.', 
      icon: <Network size={48} strokeWidth={1.5} className="text-[#FF5B00]" /> 
    },
    { 
      title: 'Design.', 
      description: 'Vårt designteam lager wireframes og prototyper, og sikrer en sømløs brukeropplevelse og en fantastisk visuell identitet. Vi fokuserer på konverteringsoptimaliserte layouter.', 
      icon: <PenTool size={48} strokeWidth={1.5} className="text-[#FF5B00]" /> 
    },
    { 
      title: 'Utvikling.', 
      description: 'Vi gir designene liv ved hjelp av moderne, skalerbare teknologier, og sikrer at nettsiden din er rask, sikker og responsiv. Ren kodearkitektur garanterer enkel vedlikehold.', 
      icon: <Code2 size={48} strokeWidth={1.5} className="text-[#FF5B00]" /> 
    },
    { 
      title: 'Lansering.', 
      description: 'Etter grundig testing på alle enheter og nettlesere, distribuerer vi nettstedet ditt og gir løpende støtte for å sikre at det fortsetter å prestere på sitt beste.', 
  ...
  const otherServices = [
    { 
      name: 'Sosiale Medier Marketing', 
      desc: 'Engasjer følgerne dine og få nye leads for din bedrift.', 
      link: '/services/social-media',
      color: 'bg-[#00C853]',
      video: '/media/social media video.mp4'
    },
    { 
  ...
  return (
    <div className="bg-[#050505] min-h-screen">
      <SEO
        title={`Nettsideutvikling – ${BUSINESS.shortName} | Profesjonelle nettsider Trondheim`}
        description="Vi bygger moderne, hurtige nettsider og webapplikasjoner for bedrifter i Trondheim. Responsivt design, SEO og skalerbar løsning."
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-sm">
                    ...
                    <div className="text-[#FF5B00] text-xs font-medium">★ 4.9/5 Vurdering</div>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section ref={processRef} className="py-16 md:py-24 bg-[#050505] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="text-center mb-16">
            <h2 className="text-white font-bold tracking-widest uppercase text-sm mb-4">VÅR PROSESS</h2>
      ...
      {/* Pricing CTA */}
      <PricingCTA serviceName="Nettsideutvikling" />
