...
export const EmailMarketing = () => {
  ...
  const processSteps = [
    { 
      title: 'Strategi.', 
      description: 'Vi analyserer din kundeliste og segmenterer publikum for å sikre at riktig budskap når riktig person til riktig tid.', 
      icon: <Network size={48} strokeWidth={1.5} className="text-[#FF5B00]" /> 
    },
    { 
      title: 'Design.', 
      description: 'Vi designer visuelt slående e-poster som er optimalisert for alle enheter og som driver mottakeren mot handling.', 
      icon: <PenTool size={48} strokeWidth={1.5} className="text-[#FF5B00]" /> 
    },
    { 
      title: 'Automatisering.', 
      description: 'Vi setter opp automatiserte flyter som velkomstserier, forlatte handlekurver og re-engasjering for å øke salget mens du sover.', 
      icon: <Code2 size={48} strokeWidth={1.5} className="text-[#FF5B00]" /> 
    },
    { 
      title: 'Analyse.', 
      description: 'Vi sporer åpningsrater, klikkrater og konverteringer for å kontinuerlig forbedre resultatene av dine kampanjer.', 
  ...
  return (
    <div className="bg-[#050505] min-h-screen">
      <SEO
        title={`E-post Markedsføring – ${BUSINESS.shortName} | E-postkampanjer Trondheim`}
        description="Bygg e-postlister, automatiser kampanjer og konverter leads til kunder. E-post markedsføring fra Asoldi."
        path="/services/email-marketing"
        structuredData={getServiceSchema('E-post Markedsføring', 'E-postkampanjer og e-postlister for bedrifter.', SITE_URL + '/services/email-marketing')}
      />
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl lg:text-[80px] font-medium text-white mb-6 tracking-tight leading-[1.05]">
                Målrettede kampanjer,<br /><span className="text-[#FF5B00]">lojale kunder</span>
              </h1>
              <p className="text-lg md:text-xl lg:text-2xl text-white/60 font-light mb-10 max-w-lg leading-relaxed">
                Gjør leads om til lojale kunder. Oppdag hvorfor bedrifter stoler på oss med sin e-post markedsføring.
              </p>
            ...
            >
              <iframe
                title="E-post Markedsføring video"
                src="https://www.youtube.com/embed/OcuyhOafDCA?autoplay=1&mute=1&loop=1&playlist=OcuyhOafDCA&controls=1&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3&playsinline=1"
                frameBorder={0}
      ...
      {/* Pricing CTA */}
      <PricingCTA serviceName="E-post Markedsføring" />
